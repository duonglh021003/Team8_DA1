...
MaQR BIGINT IDENTITY(1,1) PRIMARY KEY ,
...
('2002-12-12','2002-12-12',10,N'không',20,DEFAULT,1,1,1,1,1,1),
('2002-12-12','2002-12-12',30,N'không',60,DEFAULT,1,1,1,1,1,1),
('2002-12-12','2002-12-12',50,N'không',100,DEFAULT,1,1,1,1,1,1)
select *
from
ChiTietSP
...
NgayTao Date DEFAULT NULL,
MoTa NVARCHAR(50) DEFAULT NULL,
TongTienHoaDon DECIMAL(20,3) DEFAULT NULL, 
ThanhTien DECIMAL(20,3) DEFAULT NULL, 
TienKhachDua DECIMAL(20,3) DEFAULT NULL, 
TienThuaTraKhach DECIMAL(20,3) DEFAULT NULL, 
TrangThai INT DEFAULT 0 ,
...
('ma01','2002-12-12',N'không',80.500,100.444,150,50,DEFAULT,87647384,12072005,1),
('ma02','2002-12-12',N'không',80,100,150,50,DEFAULT,87647384,12072005,1)
select *
from
HoaDon
...
(2,2,10,20,200,DEFAULT),
(1,1,5,10,50,DEFAULT),
(1,2,10,20,200,DEFAULT)
select *
from
HoaDonChiTiet
